<template>
  ...
  >
    ...
    <div
      v-if="contentBlocked"
      class="contentBlockOverlay"
    >
      <div class="blockOverlayContent">
        <div class="blockIcon">
          <font-awesome-icon
            :icon="['fas', 'shield-alt']"
            class="shieldIcon"
        ...
        <h2 class="blockTitle">Content Not Available</h2>
        <p class="blockMessage">
          This video might not be the best fit right now. Let's find something else to watch!
        </p>
        <div class="blockActions">
          <button 
            class="blockButton blockButtonPrimary"
            @click="goBackFromBlockedContent"
          >
    ...
    >
      ...
      <watch-video-recommendations
        v-if="!isLoading && !hideRecommendedVideos && !geminiFilterInProgress"
      ...
      />
      <ft-card
        v-else-if="!isLoading && !hideRecommendedVideos && geminiFilterInProgress"
        class="watchVideoSideBar watchVideoRecommendations"
        :class="{
          theatreRecommendations: useTheatreMode,
          watchVideoRecommendationsLowerCard: watchingPlaylist || isLive,
      ...
      >
        <div class="geminiLoadingIndicator">
          <ft-loader />
          <p>Analyzing recommendations with AI...</p>
        </div>
      </ft-card>
    </div>
  </div>
