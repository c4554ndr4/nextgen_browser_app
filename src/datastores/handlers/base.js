...
class Settings {
  static async find() {
    ...
    // In Kid Safe Browser 0.21.3 and earlier the locales 'en-GB', 'es-AR' and 'nb-NO' had underscores instead of a hyphens
    ...
    // In Kid Safe Browser 0.22.0 and earlier the external player arguments were displayed in a text box,
    ...
    // In Kid Safe Browser 0.23.0, the "Enable Theatre Mode by Default" setting was incoporated as an option
